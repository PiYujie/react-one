...
class Xmdetail extends React.Component{
	...
	componentDidMount(){
        ...
        {/*获取内容*/}
		$.ajax({
			url:"http://www.piyujie.top:3000/getMusicDetail",
			type:"post",
			dataType:"json",
			data:{
		...
		//获取评论
		$.ajax({
			url:"http://www.piyujie.top:3000/getcomment",
			type:"post",
			dataType:"json",
			success(data){					
				_this.setState({
	...
	//获取评论内容
	 ...
	 sendcomment(){	 
	 	...
	 	if(sessionStorage.length>=1){
    		...
    		$.ajax({
    			url:"http://www.piyujie.top:3000/showcomment",
    			type:"post",
    			dataType:"json",
    			data:{
    			...
    			success(data){					
					$.ajax({
						url:"http://www.piyujie.top:3000/changecomment",
						type:"post",
						dataType:"json",
						success(data){
							console.log(data)
